...
public class SecurityEvaluationContextExtension implements EvaluationContextExtension {
	...
	private final DefaultAuthorizationManagerFactory<Object> defaultAuthorizationManagerFactory = new DefaultAuthorizationManagerFactory<>();

	private AuthorizationManagerFactory<Object> authorizationManagerFactory = this.defaultAuthorizationManagerFactory;
