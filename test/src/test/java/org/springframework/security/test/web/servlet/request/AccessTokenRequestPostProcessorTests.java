...
public class AccessTokenRequestPostProcessorTests extends AbstractRequestPostProcessorTests {
	...
	public void test() {
		final AccessTokenRequestPostProcessor rpp = accessToken().name(TEST_NAME)
		...
		assertThat((Collection<String>) actual.getTokenAttributes().get(OAuth2IntrospectionClaimNames.SCOPE))
				.containsExactlyInAnyOrder("test:claim");
	}
