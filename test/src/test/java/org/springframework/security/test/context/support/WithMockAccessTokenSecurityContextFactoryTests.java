...
public class WithMockAccessTokenSecurityContextFactoryTests {
	...
	public void defaults() {
		...
		assertThat(attributes.get(OAuth2IntrospectionClaimNames.USERNAME)).isEqualTo(Defaults.AUTH_NAME);
	}
	...
	public void scopesMixedInAuthoritiesAndClaims() {
		...
		assertThat((Set<String>) attributes.get(OAuth2IntrospectionClaimNames.SCOPE)).containsExactlyInAnyOrder("b");
