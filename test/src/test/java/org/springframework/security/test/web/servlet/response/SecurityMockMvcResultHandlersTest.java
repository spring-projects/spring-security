...
public class SecurityMockMvcResultHandlersTest {
	...
	@Test
	@WithMockUser
	public void withSecurityContextCopiedToSecurityContextHolder() throws Exception {
		this.mockMvc.perform(get("/"))
				.andDo(SecurityMockMvcResultHandlers.copySecurityContextToSecurityContextHolder());
	...
	@Test
	@WithMockUser
	public void withSecurityContextNotCopiedToSecurityContextHolder() throws Exception {
		this.mockMvc.perform(get("/"));
