...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private UserDetailsService userDetailsServiceMockup() {
		...
		userDetailsService.createUser(User.withDefaultPasswordEncoder().username("admin")
				.password("test").roles("ADMIN", "USER").build());
		userDetailsService.createUser(User.withDefaultPasswordEncoder().username("user")
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.userDetailsService(userDetailsServiceMockup());
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.saml2Login()
				...
				.userDetailsService(userDetailsServiceMockup())
		;
		// @formatter:on
	}
	...
	private Saml2X509Credential getSigningCredential() {
		...
		PrivateKey pk = RsaKeyConverters.pkcs8()
				.convert(new ByteArrayInputStream(key.getBytes()));
