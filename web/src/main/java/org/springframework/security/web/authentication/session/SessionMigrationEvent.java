...
/**
 * Indicates a session was migrated in for the purposes of session fixation protection.
 *
 * @since 3.2
 * @see SessionFixationProtectionStrategy
 * @author Nick Williams <nicholas@nicholaswilliams.net>
 */
public class SessionMigrationEvent extends SessionIdChangedEvent {
    //~ Constructors ===================================================================================================
     ...
     */
    public SessionMigrationEvent(Authentication authentication, String oldSessionId, String newSessionId) {
