 ...
 */
public class SessionIdChangedEvent extends AbstractAuthenticationEvent {
    //~ Instance fields ================================================================================================
    ...
    /**
     * Constructs a new session ID changed event.
     *
     ...
     */
    public SessionIdChangedEvent(Authentication authentication, String oldSessionId, String newSessionId) {
