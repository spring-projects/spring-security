...
public class Sec2377Tests {
	...
	@Test
	public void wiringWhenParentAndChildRegisteredThenNoException() {
		parent.register(Sec2377AConfig.class).autowire();

		ConfigurableApplicationContext context =
			child.register(Sec2377BConfig.class).getContext();
