...
public class HttpSessionSaml2AuthenticationRequestRepositoryTests {
	...
	private HttpSessionSaml2AuthenticationRequestRepository repo;

	@BeforeEach
	public void setup() {
		this.request = new MockHttpServletRequest();
		this.response = new MockHttpServletResponse();
		this.repo = new HttpSessionSaml2AuthenticationRequestRepository();
	}

	@Test
	public void loadAuthenticationRequestWhenInvalidSessionThenNull() {
		AbstractSaml2AuthenticationRequest authenticationRequest = this.repo.loadAuthenticationRequest(this.request);
	...
	public void loadAuthenticationRequestWhenAttributeInSessionThenReturnsAuthenticationRequest() {
		...
		this.request.getSession();
		this.repo.saveAuthenticationRequest(mockAuthenticationRequest, this.request, this.response);
		AbstractSaml2AuthenticationRequest authenticationRequest = this.repo.loadAuthenticationRequest(this.request);
	...
	public void saveAuthenticationRequestWhenNullAuthenticationRequestThenDontSave() {
		this.request.getSession();
		this.repo.saveAuthenticationRequest(null, this.request, this.response);
		AbstractSaml2AuthenticationRequest authenticationRequest = this.repo.loadAuthenticationRequest(this.request);
		assertThat(authenticationRequest).isNull();
	}
	...
	public void removeAuthenticationRequestWhenInvalidSessionThenReturnNull() {
		AbstractSaml2AuthenticationRequest authenticationRequest = this.repo.removeAuthenticationRequest(this.request,
				this.response);
		assertThat(authenticationRequest).isNull();
	}
	...
	public void removeAuthenticationRequestWhenAttributeInSessionThenRemoveAuthenticationRequest() {
		...
		AbstractSaml2AuthenticationRequest authenticationRequest = this.repo.removeAuthenticationRequest(this.request,
				this.response);
		AbstractSaml2AuthenticationRequest authenticationRequestAfterRemove = this.repo
	...
	public void removeAuthenticationRequestWhenValidSessionNoAttributeThenReturnsNull() {
		...
		AbstractSaml2AuthenticationRequest authenticationRequest = this.repo.removeAuthenticationRequest(request,
				this.response);
