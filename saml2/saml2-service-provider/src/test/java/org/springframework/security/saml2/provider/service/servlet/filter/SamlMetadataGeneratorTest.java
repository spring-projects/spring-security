...
public class SamlMetadataGeneratorTest {
	...
	public void shouldGenerateMetadata() {
		...
		assertThat(metadataXml)
				...
				.contains("<md:AssertionConsumerService Binding=\"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect\" Location=\"http://localhost/login/saml2/sso/simplesamlphp\" index=\"1\"/>");
	}
