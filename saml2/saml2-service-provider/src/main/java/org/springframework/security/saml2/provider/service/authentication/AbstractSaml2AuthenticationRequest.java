...
public abstract class AbstractSaml2AuthenticationRequest implements Serializable {
	 ...
	 * @param relyingPartyRegistrationId the registration id of the relying party
	 */
	AbstractSaml2AuthenticationRequest(String samlRequest, String relayState, String authenticationRequestUri,
		...
		Assert.hasText(relyingPartyRegistrationId, "relyingPartyRegistrationId cannot be null or empty");
	...
	public static class Builder<T extends Builder<T>> {
		...
		/**
		 * Sets the {@code relyingPartyRegistrationId}
		 * @param relyingPartyRegistrationId the registration id of the relying party.
		 * @return this object
		 * @since 5.8
		 */
		public T withRelyingPartyRegistration(String relyingPartyRegistrationId) {
			this.relyingPartyRegistrationId = relyingPartyRegistrationId;
			return _this();
		}
