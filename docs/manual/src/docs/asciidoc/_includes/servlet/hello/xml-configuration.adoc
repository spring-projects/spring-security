...
<web-app version="3.0" xmlns="http://java.sun.com/xml/ns/javaee"
  ...
  http://java.sun.com/xml/ns/javaee/web-app_3_0.xsd">
	...
	<!--
	OPTIONAL: If using Spring MVC, makes sure Spring MVC loads in the Root ApplicationContext (contextConfigLocation defined
	by context-param) by specifying a contextConfigLocation of empty String
	<servlet>
