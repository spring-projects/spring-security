...
[[nsa-oauth2-login-tokenendpoint-access-token-response-client-ref]]
* **tokenendpoint-access-token-response-client-ref**
Reference to `OAuth2AccessTokenResponseClient`.


[[nsa-oauth2-login-userinfo-user-service-ref]]
* **userinfo-user-service-ref**
Reference to `OAuth2UserService`.


[[nsa-oauth2-login-userinfo-oidc-user-service-ref]]
* **userinfo-oidc-user-service-ref**
Reference to `OidcUserService`.


[[nsa-oauth2-login-userinfo-user-authorities-mapper-ref]]
* **userinfo-user-authorities-mapper-ref**
...
[[nsa-oauth2-login-authorizationendpoint-authorization-request-resolver-ref]]
* **authorizationendpoint-authorization-request-resolver-ref**
