...
* https://github.com/spring-projects/spring-security/issues/18059[gh-18059] - `SecurityContextHolderThreadLocalAccessor` now propagates the deferred `SecurityContext` supplier without materializing it during context snapshot capture
