...
public @interface MockOAuth2AuthorizationRequest {
	...
	String authorizationGrantType() default OidcIdTokenAuthenticationBuilder.REQUEST_GRANT_TYPE;

	String authorizationUri() default OidcIdTokenAuthenticationBuilder.REQUEST_AUTHORIZATION_URI;

	String clientId() default OidcIdTokenAuthenticationBuilder.CLIENT_ID;

	String redirectUri() default OidcIdTokenAuthenticationBuilder.REQUEST_REDIRECT_URI;
