 ...
 * @since 5.2.0
 */
public class AccessTokenRequestPostProcessor
		extends
		AbstractOAuth2RequestPostProcessor<AccessTokenRequestPostProcessor> {

	public AccessTokenRequestPostProcessor() {
		super(AccessTokenSupport.DEFAULT_AUTH_NAME, AccessTokenSupport.DEFAULT_AUTHORITIES);
	}

	@Override
	public MockHttpServletRequest postProcessRequest(final MockHttpServletRequest request) {
		final Authentication authentication = AccessTokenSupport.authentication(name, authorities, scopes, attributes);
