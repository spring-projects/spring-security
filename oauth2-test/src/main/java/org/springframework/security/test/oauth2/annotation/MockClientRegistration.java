...
public @interface MockClientRegistration {
	...
	String authorizationGrantType() default OidcIdTokenAuthenticationBuilder.CLIENT_GRANT_TYPE;

	String clientId() default OidcIdTokenAuthenticationBuilder.CLIENT_ID;

	String registrationId() default OidcIdTokenAuthenticationBuilder.CLIENT_REGISTRATION_ID;

	String tokenUri() default OidcIdTokenAuthenticationBuilder.CLIENT_TOKEN_URI;
