...
public class WithMockOidcIdSecurityContextFactoryTests {
	...
	@WithMockOidcIdToken(
			...
			scopes = { "a", "b" },
			claims = {
					@Attribute(name = IdTokenClaimNames.AUD, value = "test-audience", parseTo = TargetType.STRING_LIST),
					@Attribute(
	...
	public void defaults() {
		...
		assertThat(accessToken.getTokenValue()).isEqualTo(OidcIdSupport.DEFAULT_TOKEN_VALUE);
		...
		assertThat(auth.getName()).isEqualTo(OidcIdSupport.DEFAULT_AUTH_NAME);
		...
		assertThat(principal.getSubject()).isEqualTo(OidcIdSupport.DEFAULT_AUTH_NAME);
