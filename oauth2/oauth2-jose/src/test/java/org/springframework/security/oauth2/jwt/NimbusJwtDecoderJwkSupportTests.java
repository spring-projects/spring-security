...
public class NimbusJwtDecoderJwkSupportTests {
	...
	private static final String JWK_SET = "{\n" +
			...
			"      \"kty\": \"RSA\",\n" +
			"      \"q\": \"tWR-ysspjZ73B6p2vVRVyHwP3KQWL5KEQcdgcmMOE_P_cPs98vZJfLhxobXVmvzuEWBpRSiqiuyKlQnpstKt94Cy77iO8m8ISfF3C9VyLWXi9HUGAJb99irWABFl3sNDff5K2ODQ8CmuXLYM25OwN3ikbrhEJozlXg_NJFSGD4E\",\n" +
			"      \"d\": \"FkZHYZlw5KSoqQ1i2RA2kCUygSUOf1OqMt3uomtXuUmqKBm_bY7PCOhmwbvbn4xZYEeHuTR8Xix-0KpHe3NKyWrtRjkq1T_un49_1LLVUhJ0dL-9_x0xRquVjhl_XrsRXaGMEHs8G9pLTvXQ1uST585gxIfmCe0sxPZLvwoic-bXf64UZ9BGRV3lFexWJQqCZp2S21HfoU7wiz6kfLRNi-K4xiVNB1gswm_8o5lRuY7zB9bRARQ3TS2G4eW7p5sxT3CgsGiQD3_wPugU8iDplqAjgJ5ofNJXZezoj0t6JMB_qOpbrmAM1EnomIPebSLW7Ky9SugEd6KMdL5lW6AuAQ\",\n" +
			"      \"e\": \"AQAB\",\n" +
			"      \"use\": \"sig\",\n" +
			"      \"kid\": \"one\",\n" +
			"      \"qi\": \"wdkFu_tV2V1l_PWUUimG516Zvhqk2SWDw1F7uNDD-Lvrv_WNRIJVzuffZ8WYiPy8VvYQPJUrT2EXL8P0ocqwlaSTuXctrORcbjwgxDQDLsiZE0C23HYzgi0cofbScsJdhcBg7d07LAf7cdJWG0YVl1FkMCsxUlZ2wTwHfKWf-v4\",\n" +
			"      \"dp\": \"uwnPxqC-IxG4r33-SIT02kZC1IqC4aY7PWq0nePiDEQMQWpjjNH50rlq9EyLzbtdRdIouo-jyQXB01K15-XXJJ60dwrGLYNVqfsTd0eGqD1scYJGHUWG9IDgCsxyEnuG3s0AwbW2UolWVSsU2xMZGb9PurIUZECeD1XDZwMp2s0\",\n" +
			"      \"dq\": \"hra786AunB8TF35h8PpROzPoE9VJJMuLrc6Esm8eZXMwopf0yhxfN2FEAvUoTpLJu93-UH6DKenCgi16gnQ0_zt1qNNIVoRfg4rw_rjmsxCYHTVL3-RDeC8X_7TsEySxW0EgFTHh-nr6I6CQrAJjPM88T35KHtdFATZ7BCBB8AE\",\n" +
	...
	private static final String JWK_SET_MULTIPLE = "{\n" +
			...
			"      \"use\": \"sig\",\n" +
			"      \"crv\": \"P-256\",\n" +
			"      \"x\": \"3knCvfH2UGO1M2TQ6MzwjeKShydUsgzfKC4RKq_fjtc\",\n" +
			"      \"y\": \"EwOjE5NOh_sqR9XH-3_APfiWNNxyl6BGHcue8cvDbJ0\"\n" +
			"    }\n" +
			"  ]\n" +
			"}";
	...
	public void decodeWhenUsingSignedJwtThenReturnsClaimsGivenByClaimSetConverter() throws Exception {
		try ( MockWebServer server = new MockWebServer() ) {
			...
			NimbusJwtDecoderJwkSupport decoder = new NimbusJwtDecoderJwkSupport(jwkSetUrl);
			decoder.setRestOperations(mockJwkSetResponse(JWK_SET));
	...
	@Test
	public void checkJwkKeySelectorSupportsJwkSetAlgorithms() {
		Set<SignatureAlgorithm> algorithms = NimbusJwtDecoder.withJwkSetUri("/.well-known/jwks.json")
				.restOperations(mockJwkSetResponse(JWK_SET_MULTIPLE))
				.fetchJwkAlgorithms();
		assertThat(algorithms.contains(SignatureAlgorithm.ES256)).isTrue();
	}
