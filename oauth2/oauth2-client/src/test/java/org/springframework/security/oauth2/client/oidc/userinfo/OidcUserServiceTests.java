...
public class OidcUserServiceTests {
	...
	public void setUp() throws Exception {
		...
		when(this.accessTokenResponse.getAccessToken().getScopes()).thenReturn(authorizedScopes);
	...
	public void loadUserWhenUserInfoSuccessResponseThenReturnUser() throws Exception {
		...
		when(this.accessTokenResponse.getAccessToken().getTokenValue()).thenReturn("access-token");
