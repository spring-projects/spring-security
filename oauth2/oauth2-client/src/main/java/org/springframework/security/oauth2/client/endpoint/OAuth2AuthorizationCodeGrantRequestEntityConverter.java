...
public class OAuth2AuthorizationCodeGrantRequestEntityConverter
		implements OAuth2AuthorizationGrantRequestEntityConverter<OAuth2AuthorizationCodeGrantRequest> {

	private Customizer<OAuth2AuthorizationCodeGrantRequest> customizer = (request, headers, parameters) -> {
	};
	...
	public RequestEntity<?> convert(OAuth2AuthorizationCodeGrantRequest authorizationCodeGrantRequest) {
		...
		MultiValueMap<String, String> parameters = createParameters(authorizationCodeGrantRequest);
		this.customizer.customize(authorizationCodeGrantRequest, headers, parameters);
	 ...
	 * @since 5.5
	 */
	public final void setCustomizer(Customizer<OAuth2AuthorizationCodeGrantRequest> customizer) {
