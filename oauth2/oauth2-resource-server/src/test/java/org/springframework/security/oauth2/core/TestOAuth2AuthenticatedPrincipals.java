...
public final class TestOAuth2AuthenticatedPrincipals {
	...
	public static OAuth2AuthenticatedPrincipal active(Consumer<Map<String, Object>> attributesConsumer) {
		...
		attributes.put(OAuth2TokenIntrospectionClaimNames.AUDIENCE,
		...
		attributes.put(OAuth2TokenIntrospectionClaimNames.EXPIRES_AT, Instant.ofEpochSecond(1419356238));
		attributes.put(OAuth2TokenIntrospectionClaimNames.NOT_BEFORE, Instant.ofEpochSecond(29348723984L));
		attributes.put(OAuth2TokenIntrospectionClaimNames.ISSUER, url("https://server.example.com/"));
		attributes.put(OAuth2TokenIntrospectionClaimNames.SCOPE, Arrays.asList("read", "write", "dolphin"));
		attributes.put(OAuth2TokenIntrospectionClaimNames.SUBJECT, "Z5O3upPC88QrAjx00dis");
