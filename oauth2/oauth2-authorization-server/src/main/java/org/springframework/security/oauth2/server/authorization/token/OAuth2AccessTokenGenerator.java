...
public final class OAuth2AccessTokenGenerator implements OAuth2TokenGenerator<OAuth2AccessToken> {
	...
	private @Nullable OAuth2TokenCustomizer<OAuth2TokenClaimsContext> accessTokenCustomizer;

	private Clock clock = Clock.systemUTC();

	@Override
	public @Nullable OAuth2AccessToken generate(OAuth2TokenContext context) {
		// @formatter:off
	...
	private static final class OAuth2AccessTokenClaims extends OAuth2AccessToken implements ClaimAccessor {
		...
		private OAuth2AccessTokenClaims(TokenType tokenType, String tokenValue, @Nullable Instant issuedAt,
				@Nullable Instant expiresAt, Set<String> scopes, Map<String, Object> claims) {
