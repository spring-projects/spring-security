...
import org.springframework.security.oauth2.core.introspection.OAuth2TokenIntrospectionClaimAccessor;
...
public class OAuth2TokenIntrospectionClaimAccessorTests {
	...
	@Test
	public void getScopeWhenScopeClaimNotExistingThenReturnNull() {
		assertThat(this.claimAccessor.getScope()).isNull();
	}

	@Test
	public void getScopeWhenScopeClaimExistingThenReturnScope() {
		String expectedScopeValue = "scope1 scope2";
		this.claims.put(OAuth2TokenIntrospectionClaimNames.SCOPE, expectedScopeValue);
		assertThat(this.claimAccessor.getScope()).isEqualTo(expectedScopeValue);
	}
	...
	public void getExpiresAtWhenExpiresAtClaimExistingThenReturnExpiresAt() {
		...
		this.claims.put(OAuth2TokenIntrospectionClaimNames.EXPIRES_AT, expectedExpiresAtValue);
	...
	public void getIssuedAtWhenIssuedAtClaimExistingThenReturnIssuedAt() {
		...
		this.claims.put(OAuth2TokenIntrospectionClaimNames.ISSUED_AT, expectedIssuedAtValue);
	...
	public void getNotBeforeWhenNotBeforeClaimExistingThenReturnNotBefore() {
		...
		this.claims.put(OAuth2TokenIntrospectionClaimNames.NOT_BEFORE, expectedNotBeforeValue);
	...
	public void getSubjectWhenSubjectClaimExistingThenReturnSubject() {
		...
		this.claims.put(OAuth2TokenIntrospectionClaimNames.SUBJECT, expectedSubjectValue);
	...
	public void getAudienceWhenAudienceClaimExistingThenReturnAudience() {
		...
		this.claims.put(OAuth2TokenIntrospectionClaimNames.AUDIENCE, expectedAudienceValue);
	...
	public void getIssuerWhenIssuerClaimExistingThenReturnIssuer() throws MalformedURLException {
		...
		this.claims.put(OAuth2TokenIntrospectionClaimNames.ISSUER, expectedIssuerValue);
