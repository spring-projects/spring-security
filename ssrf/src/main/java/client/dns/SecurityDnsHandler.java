...
/**
 * Component to filter addresses according configured security rules.
...
public final class SecurityDnsHandler {
	...
	public static class Builder {
		...
		public SecurityDnsHandler build() {
			...
			DefaultInetAddressFilter filter = new DefaultInetAddressFilter(
					this.allowList, this.denyList, this.blockAllExternal, this.blockAllInternal, this.customFilters);
