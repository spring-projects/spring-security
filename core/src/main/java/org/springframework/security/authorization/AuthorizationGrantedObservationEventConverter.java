...
public final class AuthorizationGrantedObservationEventConverter
		implements Converter<AuthorizationGrantedEvent, Observation.Event> {

	private final AuthorizationObservationConvention convention = new AuthorizationObservationConvention();

	@Override
	public Observation.Event convert(AuthorizationGrantedEvent event) {
