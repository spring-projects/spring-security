...
/**
 * A parent class for {@link ReactiveAuthorizationGrantedEvent} and
 * {@link ReactiveAuthorizationDeniedEvent}.
 *
 * @author Marcus da Coregio
 * @since 6.3
 */
public class ReactiveAuthorizationEvent extends ApplicationEvent {

	private final Mono<Authentication> authentication;

	private final AuthorizationDecision decision;

	/**
	 * Construct an {@link ReactiveAuthorizationEvent}
	 ...
	 */
	public ReactiveAuthorizationEvent(Mono<Authentication> authentication, Object object,
