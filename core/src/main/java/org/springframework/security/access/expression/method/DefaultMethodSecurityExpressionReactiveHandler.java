...
import org.springframework.security.access.expression.AbstractSecurityExpressionReactiveHandler;
...
/**
 * The standard implementation of {@code MethodSecurityExpressionReactiveHandler}.
 * <p>
 ...
 * @since 5.4
 */
public class DefaultMethodSecurityExpressionReactiveHandler extends
		AbstractSecurityExpressionReactiveHandler<MethodInvocation> implements
		MethodSecurityExpressionReactiveHandler {
	...
	public DefaultMethodSecurityExpressionReactiveHandler() {
	}
	 ...
	 * implementation.
	 */
	public StandardEvaluationContext createEvaluationContextInternal(Mono<Authentication> auth,
			MethodInvocation mi) {
		return new MethodSecurityEvaluationReactiveContext(auth, mi, getParameterNameDiscoverer());
	}

	/**
	 * Creates the root object for expression evaluation.
	 */
	protected MethodSecurityExpressionReactiveOperations createSecurityExpressionRoot(
			Mono<Authentication> authentication, MethodInvocation invocation) {
		MethodSecurityExpressionReactiveRoot root = new MethodSecurityExpressionReactiveRoot(
				authentication);
