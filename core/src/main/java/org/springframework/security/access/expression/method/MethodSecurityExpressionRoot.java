 ...
 * @since 3.0
 */
final class MethodSecurityExpressionRoot extends SecurityExpressionRoot<MethodInvocation>
	...
	MethodSecurityExpressionRoot(Supplier<Authentication> authentication, MethodInvocation methodInvocation) {
