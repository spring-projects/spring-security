 ...
 * @since 5.4
 */
public interface SecurityExpressionReactiveHandler<T> extends AopInfrastructureBean {
	/**
	 ...
	 * invocation type.
	 */
	EvaluationContext createEvaluationContext(Mono<Authentication> authentication, T invocation);
}
