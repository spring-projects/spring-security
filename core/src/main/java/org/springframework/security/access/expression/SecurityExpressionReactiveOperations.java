...
public interface SecurityExpressionReactiveOperations {
	 ...
	 */
	Mono<Boolean> hasAuthority(String authority);
	 ...
	 */
	Mono<Boolean> hasAnyAuthority(String... authorities);
	 ...
	 */
	Mono<Boolean> isFullyAuthenticated();
	 ...
	 * false
	 */
	Mono<Boolean> hasPermission(Object target, Object permission);
	 ...
	 * false
	 */
	Mono<Boolean> hasPermission(Object targetId, String targetType, Object permission);
