 ...
 * @since 5.4
 */
public abstract class AbstractSecurityExpressionReactiveHandler<T> implements
		SecurityExpressionReactiveHandler<T>, ApplicationContextAware {
	 ...
	 */
	public final EvaluationContext createEvaluationContext(Mono<Authentication> authentication,
			T invocation) {
		SecurityExpressionReactiveOperations root = createSecurityExpressionRoot(authentication,
				invocation);
	...
	protected StandardEvaluationContext createEvaluationContextInternal(
			Mono<Authentication> authentication, T invocation) {
	 ...
	 */
	protected abstract SecurityExpressionReactiveOperations createSecurityExpressionRoot(
			Mono<Authentication> authentication, T invocation);
