 ...
 * "<a href="https://en.wikipedia.org/wiki/Key_strengthening">password stretching</a>" for the digest calculation.
 *
 * @author Ray Krueger
 * @author Luke Taylor
 * @since 1.0.1
...
public class MessageDigestPasswordEncoder extends BaseDigestPasswordEncoder {
     ...
     * Supports the named <a href="https://java.sun.com/j2se/1.4.2/docs/guide/security/CryptoSpec.html#AppA">
